 ...
 */
final class Version20230703170841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', generate_options_theme VARCHAR(255) NOT NULL, generate_options_keywords LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', generate_options_title VARCHAR(255) DEFAULT NULL, generate_options_promoted_words LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', generate_options_images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', generate_options_size_begin SMALLINT NOT NULL, generate_options_size_end SMALLINT NOT NULL, INDEX IDX_BFDD3168F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
